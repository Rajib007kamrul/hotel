    ...
    <div class="row">
        <div class="col-md-1 ">
            <div class="icon-bar-social">
                <ul>
                    <li>
                        <a href="#" class="facebook sl-button" 
                            data-post-id="<?php echo get_the_ID(); ?>" 
                            data-iscomment="0" 
                        >
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/Icon.svg" alt="">
                        </a>
                    </li>

                    <li>
                        <a href="#" class="font-size-18 poppins font-weight-600 "> 
                        <span class="font-size-16 single_like">
                            <?php echo get_post_meta( get_the_ID(), "_post_like_count", true ); ?> </span> <br />
            ...
            <div class="author-social border-top border-bottom py-3 mt-5">
                <div class="row">
                    ...
                    <div class="col-md-6 d-flex align-items-center justify-content-start d-md-flex align-items-md-center justify-content-md-end social pt-4 pt-md-0">
                        ...
                        <a href="<?php echo $facebookURL; ?>"> <i class="fab fa-facebook"></i></a>
                        <a href="<?php echo $twitterURL; ?>"> <i class="fab fa-twitter"></i></a>
                        <a href="<?php echo $pinterestURL; ?>"> <i class="fab fa-pinterest"></i></a>
                    </div>
                </div>
            </div>
            <!--- End author -->
