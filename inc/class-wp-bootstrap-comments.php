...
?>
        <!-- <<?php echo $tag; ?> id="comment-<?php comment_ID(); ?>" <?php comment_class( $class_str, $comment ); ?>> -->
            ...
            <div id="div-comment-<?php comment_ID(); ?>" class="<?php if ( $depth == 1 ) { echo 'row comment-layout'; } ?>">
                <div class="media col-md-12 pb-4 pt-4">
...
<?php
    ...
    {
        $avatar_string = get_avatar( $comment, $args['avatar_size'],  'avatar_default', '', [ 'class' => 'd-flex mr-3 rounded-circle mr-4 align-self-start'] );
